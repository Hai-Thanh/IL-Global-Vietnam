...
<div class="all-service mt-3">
    ...
    <div class="d-flex flex-column mt-4">
        <div class="d-md-flex">
            <div><img style="width: 62px;height: 62px; object-fit: cover;border-radius: 50px" src="{{asset('ui/img/img-demo/container-demo.png')}}" alt=""></div>
            <div class="pl-2">
                ...
                <div class="cmt-blog">This Place Really Place For</div>
            </div>
        </div>
    </div>
    <div class="d-flex flex-column mt-4">
        <div class="d-md-flex">
            <div><img style="width: 62px;height: 62px; object-fit: cover;border-radius: 50px" src="{{asset('ui/img/img-demo/img-demo-about-us.png')}}" alt=""></div>
            <div class="pl-2">
                <div class="d-md-flex justify-content-between align-items-center">
                    <div class="mr-4 sub-color">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="d-flex flex-column mt-4">
        <div class="d-md-flex">
            <div><img style="width: 62px;height: 62px; object-fit: cover;border-radius: 50px" src="{{asset('ui/img/img-demo/img-demo-service-2.png')}}" alt=""></div>
            <div class="pl-2">
                <div class="d-md-flex justify-content-between align-items-center">
                    <div class="mr-4 sub-color">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="all-service mt-3">
    ...
    <div class="d-flex flex-column mt-4">
        <div class="border-bottom-category">
            <div class="d-md-flex justify-content-between align-items-center mb-2 hover-category hover-category">
                <div class="category-title">Introductions</div>
                <div class="view-category">15</div>
            </div>
        </div>
    </div>
    <div class="d-flex flex-column mt-4">
        <div class="border-bottom-category">
            <div class="d-md-flex justify-content-between align-items-center mb-2 hover-category">
    ...
    <div class="d-flex flex-column mt-4">
        <div class="border-bottom-category">
            <div class="d-md-flex justify-content-between align-items-center mb-2 hover-category">
                <div class="category-title">Logistics</div>
                <div class="view-category">15</div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex flex-column mt-4">
        <div class="border-bottom-category">
            <div class="d-md-flex justify-content-between align-items-center mb-2 hover-category">
                <div class="category-title">Work Permits</div>
                <div class="view-category">15</div>
            </div>
        </div>
    </div>
...
<div class="all-service mt-3">
    ...
    <div class="d-flex mt-4 flex-wrap gap-2">
            <a href=""><div class="btn-category">Business</div></a>
            <a href=""><div class="btn-category">Career</div></a>
            <a href=""><div class="btn-category">Logistics</div></a>
            <a href=""><div class="btn-category">Delivery</div></a>
            <a href=""><div class="btn-category">Consulting</div></a>
            <a href=""><div class="btn-category">Travel</div></a>
            <a href=""><div class="btn-category">Education</div></a>
            <a href=""><div class="btn-category">America</div></a>
            <a href=""><div class="btn-category">Maintenance</div></a>
